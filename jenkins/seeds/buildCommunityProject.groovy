            ...
            podTemplate(
              ...
              yaml: """
                ...
                spec:
                  ...
                  containers:
                  - name: project-builder
                    image: virtuslab/scala-community-build-project-builder:jdk${params.javaVersion?: 11}-v0.0.18
          ...
          steps {
            podTemplate(
              ...
              containers: [
                containerTemplate(
                  name: 'reporter',
                  image: 'virtuslab/scala-community-build-project-builder:jdk11-v0.0.18',
                  command: 'sleep',
                  args: '15m',
