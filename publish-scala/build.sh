...
export CB_MVN_REPO_URL="$3" # e.g. https://mvm-repo/maven2/2021-05-23_1
...
sbt \
  \;'set every sonatypePublishToBundle := Some(("Community Build Repo" at sys.env("CB_MVN_REPO_URL")).withAllowInsecureProtocol(true))'  \
